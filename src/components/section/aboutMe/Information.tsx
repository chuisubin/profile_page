  ...
  return (
    <div className=" flex flex-col gap-2">
      ...
      <div className=" flex flex-row items-center justify-center">
        ...
        <span className="mr-2">{t("aboutMe.bornIn")}:</span>
        <span className=" ">{infoData.bornIn}</span>
      </div>
      <div className=" flex flex-row items-center justify-center">
        <HomeIcon className="w-5 h-5 mr-2" />
        <span className="mr-2">{t("aboutMe.address")}:</span>
        <span className=" ">{infoData.address}</span>
      </div>
    </div>
  );
};
